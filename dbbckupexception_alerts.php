...
$host     = 'localhost';
$db       = 'esurv';
$table    = 'exception_alerts'; // table to dump

$dumpPath = "F:\\Prabir\\23serverEsurvDB_Backup\\backupsql/exception_alerts/exception_alerts_table_dump_{$yesterdaydate}.sql";

// Optional WHERE condition (set to "" to dump everything)
$whereClause = "CAST(edatetime AS DATE)= '$yesterdaydate'";
