...
$sql = "DELETE FROM alerts_backup WHERE CAST(receivedtime AS DATE) < CURDATE() - INTERVAL 3 DAY ORDER BY id ASC LIMIT 50000;";
//$sql = "DELETE FROM alerts_backup WHERE receivedtime BETWEEN '2025-10-31 20:00:00' AND '2025-10-31 23:59:59'";
