...
//$sql = "DELETE FROM alerts WHERE CAST(receivedtime AS DATE) < CURDATE() - INTERVAL 3 DAY ORDER BY id ASC LIMIT 5000;";
$sql = "DELETE FROM alerts WHERE CAST(receivedtime AS DATE) < CURDATE() - INTERVAL 3 DAY ORDER BY id ASC LIMIT 50000;";
