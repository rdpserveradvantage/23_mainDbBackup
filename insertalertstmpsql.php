...
$sql = "INSERT INTO tmp_alerts SELECT * FROM alerts WHERE receivedtime >= '2025-07-31 23:00:00' AND receivedtime <= '2025-07-31 23:59:59' ORDER BY id ASC";
//$sql = "DELETE FROM alerts WHERE CAST(receivedtime AS DATE) = '2025-07-25' ORDER BY id ASC LIMIT 5000;";
// Build the DELETE SQL command6
...
if ($returnVar === 0) {
    echo "Records inserted successfully datetime $script_run_time.";
} else {
    echo "Failed to insert records. Return code: $returnVar\n";
    echo "Output:\n" . implode("\n", $output);
}
