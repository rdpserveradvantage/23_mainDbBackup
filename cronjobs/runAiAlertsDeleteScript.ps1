...
$phpScriptZipPath = "C:\wamp64\www\mainDbBackup\deleteaialertsql.php"

# Log file paths
$outputLogFile = "C:\wamp64\www\mainDbBackup\cronjobs\script_aialerts_output.txt"
$errorLogFile = "C:\wamp64\www\mainDbBackup\cronjobs\script_aialerts_error.txt"
