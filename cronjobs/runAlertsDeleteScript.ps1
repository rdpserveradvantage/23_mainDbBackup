...
$phpScriptZipPath = "C:\wamp64\www\mainDbBackup\deletesql.php"

# Log file paths
$outputLogFile = "C:\wamp64\www\mainDbBackup\cronjobs\script_output.txt"
$errorLogFile = "C:\wamp64\www\mainDbBackup\cronjobs\script_error.txt"
